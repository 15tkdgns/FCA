 ...
 * ===============================
 * 
 * safe fraud detection page loading
                ...
                data: [
                    {
                        ...
                        y: [
                            this.fraudData.accuracy || 0.948,
                            this.fraudData.precision || 0.825,
                            this.fraudData.recall || 0.712,
                            this.fraudData.f1_score || 0.764
                        ],
                        type: 'bar',
                        marker: { color: ['#dc2626', '#2563eb', '#059669', '#d97706'] },
                        text: [
                            `${((this.fraudData.accuracy || 0.948) * 100).toFixed(1)}%`,
                            `${((this.fraudData.precision || 0.825) * 100).toFixed(1)}%`,
                            `${((this.fraudData.recall || 0.712) * 100).toFixed(1)}%`,
                            `${((this.fraudData.f1_score || 0.764) * 100).toFixed(1)}%`
                        ],
                        textposition: 'auto'
                    }
                ],
