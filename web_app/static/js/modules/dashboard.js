...
export class Dashboard {
    ...
    async init() {
        try {
            ...
            utils.showError('대시보드를 초기화하는 중 오류가 발생했습니다.');
        } finally {
    ...
    async loadCharts() {
        ...
        const chartPromises = charts.map(async (chart) => {
            try {
                ...
                utils.showError(`${chart.type} 차트를 불러오는데 실패했습니다.`, chart.containerId, error.message);
            }
        });
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card performer-card">
                    <div class="card-body text-center">
                        ...
                        <h6 class="card-title">사기 탐지 최고 성능</h6>
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card performer-card">
                    <div class="card-body text-center">
                        ...
                        <h6 class="card-title">감정 분석 최고 성능</h6>
        ...
        if (detailsEl) {
            detailsEl.innerHTML = `
                <small class="text-muted">
                    ...
                    상태: <span class="text-success">활성</span><br>
                    캐시: ${metrics.api.cacheSize}개 항목
                </small>
            `;
        }
    }
    ...
    async refresh() {
        try {
            ...
            utils.showError('대시보드 새로고침 중 오류가 발생했습니다.');
        } finally {
